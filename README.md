...
<img width="1280" height="853" alt="image" src="https://github.com/user-attachments/assets/209080f3-c280-40e0-bfd2-46125a8e8318" />
...
[PolyForm Noncommercial License 1.0.0](LICENSE). In plain English: free for personal, hobby,
noncommercial and nonprofit/educational/government use. No commercial use, period — there's no
trial period and no path to one without contacting the licensor directly. Provided as is, with
no warranty and no hosted service.
